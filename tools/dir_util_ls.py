...
def list_files_in_directory(dirname, pattern,
                            recursive=False, get_relative_path=False, verbose=False,
                            outfile=sys.stdout):
    files = dir.DirectoryUtility.list_files(
        dirname, pattern,
        recursive=recursive, get_relative_path=get_relative_path, verbose=verbose
    )
    ...
    if args.directory_only:
        for dirname in args.dirnames:
            list_subdirectories_in_directory(
                ...
                recursive=args.recursive, get_relative_path=args.get_relative_path,
